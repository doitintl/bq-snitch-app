...
def send_slack_alert(wekbook_url, web_api_token, dest_channel, query, job_id, project,
                     location, user_email, cost, gigabytes_billed):
    try:
        message_blocks = [
            {
                "type": "section",
...
def send_slack_alert_web_api(web_api_token, dest_channel, message_blocks, user_email):
    ...
    try:
        ...
        utils.print_and_flush("Failed to send slack alert to channel: " + dest_channel)
        utils.print_and_flush(e)
    ...
    try:
        ...
        utils.print_and_flush("Failed to send slack alert to user: " + user_email)
        utils.print_and_flush(e)
